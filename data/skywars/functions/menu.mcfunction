...
tellraw @s [{"text":"[Go to SkyWars Lobby]","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger sw.lobby"},"hoverEvent":{"action":"show_text","value":{"text":"Go to the SkyWars lobby to play a game","color":"aqua"}}}]
tellraw @s [" "]
