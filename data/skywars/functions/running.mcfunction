...
spawnpoint @a[x=25,y=138,z=1,distance=..10,team=!ready,nbt={Dimension:"skywars:skywars"}] 25 138 1
tp @a[x=25,y=138,z=1,distance=..11,gamemode=spectator,nbt={Dimension:"skywars:skywars"}] 25 138 1
team join lobby @a[x=25,y=138,z=1,distance=..10,team=!ready,nbt={Dimension:"skywars:skywars"}]
gamemode adventure @a[x=25,y=138,z=1,distance=..10,nbt={Dimension:"skywars:skywars"}]

# Death commands
team join spectator @a[scores={deaths=1..},nbt={Dimension:"skywars:skywars"}]
gamemode spectator @a[team=spectator,nbt={Dimension:"skywars:skywars"}]
scoreboard players reset * deaths
execute as @a[team=spectator,x=0,y=-256,z=0,distance=..256,nbt={Dimension:"skywars:skywars"}] run tp @s ~ 64 ~
